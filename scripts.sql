...
-- Incluir usuário
INSERT INTO "Usuarios"(id, nome, endereco, numero, complemento, bairro, cidade, uf, cep, telefone, email, senha, status, cpf, perfil, created_at, updated_at, id_cliente, id_coordenador) VALUES (0, 'admin', 'rua teste','1','sala 1','Centro','Rio de Janeiro','RJ','20541020', '021987654321', 'admin@admin.com', '$2b$10$Mcpe6xDQ75.ESfQ7uxjdROYAwQuZeLPDKwDRFjoPvLNYu6MITXlDi', true, '98765432100', 1, NOW(), NOW(), null, null);
